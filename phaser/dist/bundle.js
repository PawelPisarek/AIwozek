...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.findGraphNode = exports.distance = exports.setResponsiveWidth = exports.getRandomInt = exports.centerGameObjects = undefined;

	var _GraphNode = __webpack_require__(/*! ./logic/GraphNode */ 296);
	...
	var distance = exports.distance = function distance(obj, obj2) {
	  // import GraphNode from '../GraphNode'
	  // let obj= {x:2,y:5};
	  // let obj2= {x:5,y:9};
	  if (!(obj instanceof _GraphNode2.default)) {
	    // console.log("obiekt nie znajduje się na liscie");
	    return false;
	  }
	  if (!(obj2 instanceof _GraphNode2.default)) {
	...
	var findGraphNode = exports.findGraphNode = function findGraphNode(arr, obj) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Graph = __webpack_require__(/*! ../logic/Graph */ 297);

	var _Graph2 = _interopRequireDefault(_Graph);

	var _neighborGraph = __webpack_require__(/*! ../logic/neighborGraph */ 298);

	var _neighborGraph2 = _interopRequireDefault(_neighborGraph);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    key: 'DodajemyPoleStartoweLubWęzełdoListyOtwartych',
	    value: function DodajemyPoleStartoweLubWZeDoListyOtwartych(obj) {
	    ...
	    key: 'neighbor_nodes',
	    value: function neighbor_nodes(node, taget) {
	      var _this3 = this;

	      var neighborNodes = new _neighborGraph2.default({ nodes: this.graph.nodes, node: node });
	      [{ x: neighborNodes.center.x - 1, y: neighborNodes.center.y }, { x: neighborNodes.center.x + 1, y: neighborNodes.center.y }, { x: neighborNodes.center.x, y: neighborNodes.center.y - 1 }, { x: neighborNodes.center.x, y: neighborNodes.center.y + 1 }].forEach(function (neighbor) {

	        neighbor = (0, _utils.findGraphNode)(_this3.graph.nodes, neighbor);
	        if ((0, _utils.distance)(neighborNodes.center, neighbor) !== false) {
	          neighborNodes.add({ node: neighbor.pos, distance: (0, _utils.distance)(neighborNodes.center, neighbor) });
	        }
	      });
	    ...
	    key: 'SzukamyPolaONajniższejWartościFnaLiścieOtwartychCzynimyJeAktualnymPolem',
	    value: function SzukamyPolaONajniSzejWartoCiFnaLiCieOtwartychCzynimyJeAktualnymPolem(obj, taget) {
	      console.log("SzukamyPolaONajniższejWartościFnaLiścieOtwartychCzynimyJeAktualnymPolem");
	      // console.log(this.neighbor_nodes(obj));
	      var neighbotNodes = this.neighbor_nodes(obj, taget);
	    ...
	    key: 'AktualnePolePrzesuwamyDoListyZamkniętych',
	    value: function AktualnePolePrzesuwamyDoListyZamkniTych() {
	      console.log("AktualnePolePrzesuwamyDoListyZamkniętych");
	    }
	  }, {
	    key: 'DlaKażdegoZ8PrzyległychPólDoPolaAktualnegoZSprawdzamy',
	    value: function DlaKaDegoZ8PrzylegYchPLDoPolaAktualnegoZSprawdzamy() {
	      console.log("DlaKażdegoZ8PrzyległychPólDoPolaAktualnegoZSprawdzamy");
	    }
	  }, {
	    key: 'JeśliNIEMOŻNAGoPrzejśćLubJestJużNaLiścieZamkniętychIgnorujemyJeWInnymPrzypadkuSprawdzamy',
	    value: function JeLiNIEMONAGoPrzejLubJestJuNaLiCieZamkniTychIgnorujemyJeWInnymPrzypadkuSprawdzamy() {
	      console.log("JeśliNIEMOŻNAGoPrzejśćLubJestJużNaLiścieZamkniętychIgnorujemyJeWInnymPrzypadkuSprawdzamy");
	    }
	  }, {
	    key: 'JeśliPoleNieJestJeszczeNaLiścieOtwartychDodajemyJeDoNiejAktualnePoleZPrzypisujemyMuXnJakoPoleRodzicaIZapisujemyJegoWartościFGiH',
	    value: function JeLiPoleNieJestJeszczeNaLiCieOtwartychDodajemyJeDoNiejAktualnePoleZPrzypisujemyMuXnJakoPoleRodzicaIZapisujemyJegoWartoCiFGiH() {
	    ...
	    key: 'JeśliPoleByłoJużNaLiścieOtwartychSprawdzamyCzyAktualnaScieżkaDoTegopolaProwadzącaprzezZJestLepszaKrótszaPoprzezPorównanieJegoWartościGdlaStarejiAktualnejŚcieżkiMniejszaWartośćGoznaczaŻeŚcieżkaJestKrótszaJeśliTakZmieniamyPrzypisaniePoleRodzicaNaAktualnePoleZiPrzeliczamyWartościGiFdlaPolaJeśliWaszaListaOtwartychJestPosortowanaPodKątemWartościFTrzebaJąPonowniePrzesortowaćPoWprowadzonejZmianie',
	    value: function () {
	    ...
	    key: 'ZatrzymujemySieGdy',
	    value: function ZatrzymujemySieGdy() {
	      console.log("ZatrzymujemySieGdy");
	    }
	  }, {
	    key: 'DodanoPoleDoceloweDoListyZamkniętychWTymPrzypadkuŚcieżkaZostałaOdnaleziona',
	    value: function DodanoPoleDoceloweDoListyZamkniTychWTymPrzypadkuCieKaZostaAOdnaleziona() {
	      console.log("DodanoPoleDoceloweDoListyZamkniętychWTymPrzypadkuŚcieżkaZostałaOdnaleziona");
	    }
	  }, {
	    key: 'ListaOtwartychJestPustaNieIStnieje',
	    value: function ListaOtwartychJestPustaNieIStnieje() {
	      console.log("ListaOtwartychJestPustaNieIStnieje");
	    }
	  }, {
	    key: 'ZapisujemyŚcieżkęKroczącWKierunkuOdPolaDocelowegoPktBDoStartowegoPktAPrzeskakujemyZKolejnychPólNaImPrzypisanePolaRodzicówAżDoOsiągnięciaPolaStartowegoToJestWaszaŚcieżka',
	    value: function ZapisujemyCieKKroczCWKierunkuOdPolaDocelowegoPktBDoStartowegoPktAPrzeskakujemyZKolejnychPLNaImPrzypisanePolaRodzicWADoOsiGniCiaPolaStartowegoToJestWaszaCieKa() {
	    ...
	    value: function astar() {
	      ...
	      //   }
	      // }
	      this.graph.add(new _GraphNode2.default({ x: 0, y: 0, type: "sasdasd" }));
	      this.graph.add(new _GraphNode2.default({ x: 0, y: 1, type: "sasdasd" }));
	      this.graph.add(new _GraphNode2.default({ x: 0, y: 2, type: "sasdasd" }));
	      this.graph.add(new _GraphNode2.default({ x: 0, y: 3, type: "sasdasd" }));
	      this.graph.add(new _GraphNode2.default({ x: 1, y: 0, type: "sasdasd" }));
	      this.graph.add(new _GraphNode2.default({ x: 1, y: 1, type: "start" }));
	      this.graph.add(new _GraphNode2.default({ x: 1, y: 2, type: "sasdasd" }));
	      this.graph.add(new _GraphNode2.default({ x: 1, y: 3, type: "sasdasd" }));
	      this.graph.add(new _GraphNode2.default({ x: 2, y: 0, type: "sasdasd" }));
	      this.graph.add(new _GraphNode2.default({ x: 2, y: 1, type: "sasdasd" }));
	      this.graph.add(new _GraphNode2.default({ x: 2, y: 2, type: "sasdasd" }));
	      this.graph.add(new _GraphNode2.default({ x: 2, y: 3, type: "sasdasd" }));
	      this.graph.add(new _GraphNode2.default({ x: 3, y: 0, type: "sasdasd" }));
	      this.graph.add(new _GraphNode2.default({ x: 3, y: 1, type: "sasdasd" }));
	      this.graph.add(new _GraphNode2.default({ x: 3, y: 2, type: "sasdasd" }));
	      this.graph.add(new _GraphNode2.default({ x: 3, y: 3, type: "sasdasd" }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Graph2 = __webpack_require__(/*! ./Graph */ 297);
	...
	var NeighborGraph = function (_Graph) {
	    _inherits(NeighborGraph, _Graph);

	    function NeighborGraph(_ref) {
	        var nodes = _ref.nodes;
	        var node = _ref.node;

	        _classCallCheck(this, NeighborGraph);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NeighborGraph).call(this));

	        _this.center = (0, _utils.findGraphNode)(nodes, node);

	        return _this;
	    }

	    _createClass(NeighborGraph, [{
	        key: 'toString',
	        value: function toString() {
	            ...
	            var Up = find({ x: self.center.x - 1, y: self.center.y });
	            var Down = find({ x: self.center.x + 1, y: self.center.y });
	            var Left = find({ x: self.center.x, y: self.center.y - 1 });
	            var Right = find({ x: self.center.x, y: self.center.y + 1 });

	            Up != false ? console.log("      [" + Up.node.x + "," + Up.node.y + "]       ") : null;

	            var rowDebug = Left != false ? "  [" + Left.node.x + "," + Left.node.y + "]x" : "";
